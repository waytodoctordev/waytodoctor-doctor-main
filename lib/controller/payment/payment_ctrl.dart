      ...
      ..setNavigationDelegate(
        NavigationDelegate(
          ...
          onNavigationRequest: (NavigationRequest request) async {
            print('onNavigationRequest ,method in payment ctrl');
            ...
            if (request.url
              ...
              print('yes it contains facebook.com/m0ustafamahm0ud ');
              isPaymentEnded = true;
              update();
              Future.delayed(
                const Duration(seconds: 5),
...
print('subscriptionModel!.code == 200');
  ...
  Future getTransactionStatus(
    ...
    if (transactionModel!.code == 200) {
      ...
      print('transactionModel!.code == 500');
      AppConstants().showMsgToast(context, msg: AppConstants.failedMessage);

    } else {
      print('transactionModel!.code == else');
