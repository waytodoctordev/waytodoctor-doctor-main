...
class ClinicBaseNavBar extends StatefulWidget {
  const ClinicBaseNavBar({super.key});

  @override
  State<ClinicBaseNavBar> createState() => _ClinicBaseNavBarState();
}

class _ClinicBaseNavBarState extends State<ClinicBaseNavBar> {
  @override
  void initState() {
