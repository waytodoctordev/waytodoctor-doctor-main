...
import 'package:way_to_doctor_doctor/ui/base/policies_screen.dart';
...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  void initState() {
    ...
    MySharedPreferences.lastScreen='RegistrationScreen';
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          InkWell(
                            onTap: () =>
                                Get.to(() =>  PoliciesScreen(pageId: '6', policyName:'Privacy policy',),
                          ...
                          InkWell(
                            onTap: () =>
                                Get.to(() =>  PoliciesScreen(pageId: '7', policyName: 'Terms and Conditions',),
                                    binding: PoliciesBinding()),
                            child: Text(
                          ...
                          InkWell(
                            onTap: () => Get.to(() =>  PoliciesScreen(pageId: '9', policyName: 'Return policy',), binding: PoliciesBinding()),
                            child: Text(
                              'Return policy'.tr,
                              style: const TextStyle(
                                color: MyColors.blue14B,
