...
class OtpTimerResetPassWidget extends StatelessWidget {
  const OtpTimerResetPassWidget({super.key});
            ...
            child: TextButton(
              onPressed: () {
                if (MySharedPreferences.skipOtp == 0) {
                  ResetPassStep2Controller.find.resendOtp(context: context, phone: MySharedPreferences.userNumber);
