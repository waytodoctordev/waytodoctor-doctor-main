...
class ClinicPasswordComponent extends StatefulWidget {
  const ClinicPasswordComponent({Key? key}) : super(key: key);

  @override
  State<ClinicPasswordComponent> createState() =>
      _ClinicPasswordComponentState();
}

class _ClinicPasswordComponentState extends State<ClinicPasswordComponent> {
  @override
