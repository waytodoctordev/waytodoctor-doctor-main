    ...
    return Scaffold(
      body: SafeArea(
        child: RefreshIndicator(
          ...
          child: GetBuilder<DoctorAppointmentsDetailsCtrl>(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: PageView(
                                ...
                                onPageChanged: (value) =>
                                    controller.getCurrentIndex(value),
                                children: [
                                  AppointmentDetails(
                                  ...
                                  PatientPersonalInformationComponent(
                                    ...
                                    userDateOfBirth: snapshot
                                        ...
                                        .toString(),
                                    userGender: snapshot.data!.data.user!.gender
                                        .toString(),
                                    userMaritalStatus: snapshot
                                  ...
                                  PatientMedicalInformationComponent(
                                      userId: snapshot.data!.data.user!.id
                                          .toString()),
                                      ...
                                      builder: (context, agoraSnapshot) {
                                        ...
                                        if (agoraModel.isActive &&
                                          ...
                                          return SlideAction(
                                            ...
                                            snapAnimationCurve: Curves
                                                .bounceOut, // 👈 control snapping animation curve
                                            ...
                                            thumbBuilder: (context, state) {
                                              return Container(
                                                  ...
                                                  angle: state.thumbFractionalPosition * 2 * pi,
                                                  child: Center(
                                                    child: widget.bookingType ==
                                                            'call'
