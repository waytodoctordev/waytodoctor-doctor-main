...
class _DoctorSettingsScreenState extends State<DoctorSettingsScreen> {
  ...
  void initState() {
    ...
    SettingsCtrl.find.fetchDoctorWorkHours();
    super.initState();
  }
        ...
        builder: (controller) => SafeArea(
          ...
          children: [
            ...
            child: CustomElevatedButton(
              ...
              onPressed: () async {
                if (controller.currentTabBarIndex == 0) {
                ...
                else if (controller.currentTabBarIndex == 1) {
                ...
                else if (controller.currentTabBarIndex == 2) {
