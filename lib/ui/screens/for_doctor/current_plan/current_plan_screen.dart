...
import 'package:way_to_doctor_doctor/ui/screens/registration/plans/subscription_screen.dart';
...
class CurrentPlanScreen extends StatefulWidget {
  const CurrentPlanScreen({required this.currentPlan, super.key, required  this.remainingDays});
...
class _CurrentPlanScreenState extends State<CurrentPlanScreen> {
  @override
  void initState() {
    Platform.isAndroid ? Get.put(CurrentPlanCtrl()) : null;
    super.initState();
  }
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          snapshot.data!.data.plan.details
                                              .toString(),
                                          style: const TextStyle(
                                            fontSize: 14,
                                            color: MyColors.white,
