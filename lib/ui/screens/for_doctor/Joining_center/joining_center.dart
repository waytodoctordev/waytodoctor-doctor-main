...
@override
  void initState() {
  CenterCtrl.find.getCategoriesList(context);
super.initState();
  }
  @override
  Widget build(BuildContext context) {
    return GetBuilder<CenterCtrl>(builder: (centerCtrl) {
      return Scaffold(
        appBar: AppBar(
        ...
        body: SafeArea(
          ...
          child: RefreshIndicator(
            onRefresh: () async {
              centerCtrl.getCategoriesList(context);
            },
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  centerCtrl.isLoading
                      ? const SizedBox(height: 172, child: LoadingIndicator())
                      :
                      ...
                      Column(
                          ...
                          children: [
                            ...
                            centerCtrl.categoryCentersList!.isNotEmpty
                                ? Obx(
                                    () => FadeInDown(
                                      from: 6,
                                      duration:
                                      ...
                                      child: Container(
                                        ...
                                        child: DropdownButton(
                                          ...
                                          elevation: 1,
                                          items: centerCtrl.categoryCentersList
                                              ?.map(
                                          ...
                                          onChanged: (int? value) => centerCtrl
