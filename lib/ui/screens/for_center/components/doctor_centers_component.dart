...
class _DoctorsCenterScreenState extends State<DoctorsCenterScreen> {
  ...
  DoctorHomeScreenCtrl doctorHomeScreenCtrl = Get.put(DoctorHomeScreenCtrl());
  @override
  void initState() {
    ...
    print('MySharedPreferences.centerID ${MySharedPreferences.id}');
    CenterCtrl.find.fetchCenterDoctorsData(
        categoryId: MySharedPreferences.centerCategoryID,
        search: '',
        centerId: MySharedPreferences.id.toString(),
    context: context);
    super.initState();
  }
        ...
        child: Padding(
          ...
          child: RefreshIndicator(
            onRefresh: () async {
              ...
              context: context);
              // doctorHomeScreenCtrl.pagingController.refresh();
            },
            child: Column(
