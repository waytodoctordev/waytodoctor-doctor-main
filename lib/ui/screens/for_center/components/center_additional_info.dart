...
class CenterAdditionalInfoPage extends StatelessWidget {
  ...
  final SpecializationCtrl specializationCtrl = Get.put(SpecializationCtrl());
                    ...
                    onPressed: () {
                      if (formKey.currentState!.validate()) {
                        if (MySharedPreferences.userImage.isNotEmpty &&
                            formCtrl.addressCtrl.text.isNotEmpty) {
                          centerCtrl.professionalLicenseRequest(
                            context: context,
                            name: MySharedPreferences.fName,
                            phone: MySharedPreferences.userNumber,
                            imageProfile: formCtrl.image,
                            address:
                                '${formCtrl.currentCountry}|${formCtrl.currentCity}|${formCtrl.addressCtrl.text}',
                            professionalLicense:
