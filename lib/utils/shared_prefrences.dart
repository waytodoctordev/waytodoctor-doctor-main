...
class MySharedPreferences {
  ...
  static  String keyCenterCategoryID = "key_center_category_id";
  static  String keyCenterID = 'key_center_id';//"key_center_id";
  static File professionalLicense =File('');
  static File profileImage =File('');
  static bool reNewSubs =false;
  ...
  static bool get reNewSub => sharedPreferences.getBool(keyCurrentQuestionIndex) ?? false;
  static set reNewSub(bool value) => sharedPreferences.setBool(keyCurrentQuestionIndex, value);

  static String get centerCategoryID => sharedPreferences.getString(keyCenterCategoryID) ?? "";
  static set centerCategoryID(String value) =>
      sharedPreferences.setString(keyCenterCategoryID, value);

  static String get centerID => sharedPreferences.getString(keyCenterID) ?? '';
  static set centerID(String value) =>
      sharedPreferences.setString(keyCenterID, value);
