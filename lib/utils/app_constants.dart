...
class AppConstants {
  ...
  static const revenueCatAppleApiKey = 'appl_qcOhbTzuTasmrDNUAFsUkqUBsFE';
  static const revenueCatGoogleApiKey = 'goog_dFTgYgmZeGaLlbRRSvokwQkeeTT';
  ...
  static String delMethod = 'DELETE';
  ...
  return FirebaseFirestore.instance
        .collection('chat')
        .where('doctorId', isEqualTo: FirebaseAuth.instance.currentUser!.uid)
        // .where('patientId', whereIn: [MySharedPreferences.id])
