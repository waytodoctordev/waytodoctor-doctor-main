...
DoctorSignUpModel? doctorSignUpModelFromJson(String str) =>
    DoctorSignUpModel.fromJson(json.decode(str));

String doctorSignUpModelToJson(DoctorSignUpModel? data) =>
  ...
  factory DoctorSignUpModel.fromJson(Map<String, dynamic> json) =>
      DoctorSignUpModel(
        ...
        data: json["data"] != null && json["data"].isNotEmpty
            ? DoctorSignUpData.fromJson(json["data"])
            : null,
...
class DoctorSignUpData {
  ...
  factory DoctorSignUpData.fromJson(Map<String, dynamic> json) =>
      DoctorSignUpData(
        token: json["token"],
...
class UserDoctor {
  ...
  factory UserDoctor.fromJson(Map<String, dynamic> json) => UserDoctor(
        ...
        studies: json["studies"] == null
            ? []
            : List<dynamic>.from(json["studies"]!.map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "studies":
            studies == null ? [] : List<dynamic>.from(studies!.map((x) => x)),
        "pictures":
